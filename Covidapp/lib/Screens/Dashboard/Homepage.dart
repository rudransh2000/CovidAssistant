    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          widget.prefsnewtrial.setInt(
              "HomeGlobalTotalcase", decodedJson[worldstats[0]["text2"]]);
          widget.prefsnewtrial.setInt(
              "HomeGlobalTotalDeath", decodedJson[worldstats[1]["text2"]]);
          widget.prefsnewtrial.setInt(
              "HomeGlobalTotalRecovery", decodedJson[worldstats[2]["text2"]]);
          return Scaffold(
                                                ...
                                                Text(
                                                  index == 0
                                                      ...
                                                      : index == 1
                                                          ? widget.prefsnewtrial
                                                              .getInt(
                                                                  "HomeGlobalTotalDeath")
                                                              .toString()
                                                          : widget.prefsnewtrial
                                                              .getInt(
                                                                  "HomeGlobalTotalRecovery")
                                                              .toString(),
                                                  style: TextStyle(
                                                      fontSize: 23,
                                                      color: Colors.white),
