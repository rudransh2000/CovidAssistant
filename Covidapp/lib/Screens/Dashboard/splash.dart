...
class _OnboardingPageState extends State<OnboardingPage> {
  ...
  List<Map<dynamic, dynamic>> onboardingData = [
    ...
    },
    {
      ...
      "text2":
          "Get instant notification about the vaccine slots available in your city",
      "image": "Assets/Images/doctors1.svg"
    },
    {
      "text1": "SHARE INFOS",
      "text2": "Help other patients by sharing important informations",
